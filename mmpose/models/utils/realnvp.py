...
class RealNVP(nn.Module):
    ...
    def get_scale_net():
        ...
        return nn.Sequential(
            nn.Linear(1, 64), nn.LeakyReLU(), nn.Linear(64, 64),
            nn.LeakyReLU(), nn.Linear(64, 1), nn.Tanh())
    ...
    def __init__(self):
        ...
        self.register_buffer('loc', torch.zeros(1))
        self.register_buffer('cov', torch.eye(1))
