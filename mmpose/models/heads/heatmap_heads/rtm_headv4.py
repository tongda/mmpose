...
class RTMHeadv4(BaseHead):
    ...
    def __init__(
        ...
        bone_loss: ConfigType = dict(
            type='BoneSimilarityLoss', use_target_weight=True),
        ...
        self.boneloss = MODELS.build(bone_loss)
    ...
    def loss(
        ...
        bone_loss = self.boneloss(pred_x, gt_x, keypoint_weights)
        bone_loss += self.boneloss(pred_y, gt_y, keypoint_weights)
        bone_loss *= 0.5
        loss = loss + bone_loss
