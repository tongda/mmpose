...
from mmpose.utils.typing import (ConfigType, InstanceList, OptConfigType,
                                 OptSampleList)
from ...utils.gau import GAU, KeypointCoordMatching
...
class KptCoordHead(BaseHead):
    ...
    def __init__(
        ...
        self.num_kc_split = num_kc_split
    ...
    def forward(self, feats: Tuple[Tensor]) -> Tuple[Tensor, Tensor]:
        ...
        kpt_global, coord_global = self.kpt_coord_global(
            kpt_feats, coord_feats)
        ...
        pred_x_token, coord_x_token = self.kpt_coord_x(pred_x_token,
                                                       coord_x_token)
        pred_y_token, coord_y_token = self.kpt_coord_y(pred_y_token,
                                                       coord_y_token)
