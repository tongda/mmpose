...
from mmpose.utils.typing import (ConfigType, InstanceList, OptConfigType,
                                 OptSampleList)
from ...utils.gau import GAUAlpha, ScaleNorm
...
class SE(nn.Module):
    ...
    def __init__(self, num_token, in_channels):
        ...
        self.fc1 = GAUAlpha(num_token, in_channels, in_channels)
        # self.fc_out = GAUAlpha(num_token, in_channels, out_channels)
...
class RTMHeadv2(BaseHead):
    ...
    def forward(self, feats: Tuple[Tensor]) -> Tuple[Tensor, Tensor]:
        ...
        if self.use_decoder:
            ...
            if self.cross_attn:
                pred_x, coord_x_token = self.decoder_x(
                    (pred_x, coord_x_token, coord_x_token))
                pred_y, coord_y_token = self.decoder_y(
